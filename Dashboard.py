...
st.markdown('[A história do petróleo no Brasil - Foi acessado em 15 novembro 2024](https://www.gov.br/anp/pt-br/acesso-a-informacao/institucional/historia-petroleo-brasil)')
st.markdown('[Qual é a origem do petróleo? - Foi acessado em 15 novembro 2024](https://www.bbc.com/portuguese/articles/cnk0e0yydelo)')
#st.markdown('##### Fontes de dados')
st.markdown('[OPEC - Foi acessado em 15 novembro 2024]( https://www.opec.org/opec_web/en/index.htm)')
st.markdown('[OpenAI. “O Chat GPT é uma ferramenta de processamento de linguagem natural orientada por IA, que possibilita conversas semelhantes às humanas com o chatbot - Foi acessado em 15 novembro 2024](https://openai.com/blog/chat-gpt-3-launch/)')
#st.markdown('##### Fontes informacionais')
st.markdown('[Geopolítica do Petróleo - Foi acessado em 20 novembro 2024](https://mundoeducacao.uol.com.br/geografia/geopolitica-petroleo.html)') 
...
st.markdown('[Oito motivos para a queda do preço do  petróleo - Foi acessado em 20 novembro 2024](https://www.dw.com/pt-br/oito-motivos-para-a-queda-do-pre%C3%A7o-do-petr%C3%B3leo/a-19051686)') 
